...
/**
 * Convert a 2D image into a 3D model (geometry + color/texture, optional optimization & pose).
 */
@Getter
@Setter
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Create an image-to-3D task")
public class ImageTo3dRequest {
    ...
    @Schema(description = "Optional 2D image URL to guide texturing/color")
