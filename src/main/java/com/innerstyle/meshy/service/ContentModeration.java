...
/**
 * Lightweight text content policy: rejects prompts containing blocked terms
 * (sexual content,
 * exploitation, extreme violence) in English or Vietnamese. Mirrors the
 * client-side blocklist
 * and is enforced server-side as defence in depth. Image moderation is handled
 * on the client
...
public class ContentModeration {
    ...
    /**
     * Throw {@code validation.content.blocked} if any provided text contains a
     * blocked term.
     */
